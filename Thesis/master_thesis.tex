...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Formalities
\title{Non-Linear Transitions to\\Tighter Borrowing in HANK}
\author{}
\date{}
...
& \\
& \\
Date of Submission: & \printdate{2023-8-23}\\
...
\begin{center}
\textbf{Non-Linear Transitions to Tighter Borrowing in HANK}
\end{center}
...
\section*{To-Read}
%\textcite{kaplan2018}, \textcite{sw2007}
...
\label{sec:outline}
The remainder of this thesis is structured as follows. Section \ref{sec:literature} reviews the related literature.
