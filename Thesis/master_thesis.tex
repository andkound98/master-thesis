...
Households face limits to borrowing. For example, there is usually a limit to how much a credit card holder can spend with one card. Also, home buyers cannot take arbitrarily large loans for purchasing a house. Clearly, these are limits which vary across at least three dimensions: 1) household characteristics (e.g.~credit-worthiness), 2) asset type (e.g.~mortgage debt vs credit card debt) and 3) time.\footnote{This is by no means meant to be a formal or sufficient description of dimensions along which borrowing limits may vary.}

Such borrowing limits have important implications for the behaviour of households.\footnote{Of course, firms and governments can be subject to borrowing constraints, too. The focus of this thesis, however, is on households.}
