...
% The resulting increase in demand for safe assets meets, however, the aforementioned decrease in supply of assets. 
...
% , in this model, by the supply sunchanged degree of substitutability among intermediate goods.
...
%In fact, figure xx reveals that the average unconstrained debtor indeed taps into more debt upon announcement of the shock. This explains the meagre reduction in aggregate indebtedness in $t=1$ from plot \ref{fig:baseline-permanent-limit-agg-d}.
...
%Here, deflation has an interesting effect trough the Fisher equation on households' budget. As deflation arises unexpectedly in $t=1$, the real interest rate on bond holdings from $t=0$ rises too. This is an unexpected capital gain for lenders but an additional cost to borrowers.

%Reduced output and deflation urge the central bank to reduce the nominal interest rate. However, it can not do so by as much as it desires as the \Gls{zlb} binds already on impact.
