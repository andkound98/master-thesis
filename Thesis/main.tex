...
%Debt has exhibits similar patterns but different speeds in its downward adjustment. In the first ten quarters displayed in plot \ref{fig:baseline-permanent-limit-duration-D}, debt falls most strongly in the case of a quickly resolving shock than in the baseline or slow-shock instances.
...
\begin{figure}[H]
    ...
    \label{fig:init-stst-end-L-dist}
     ...
     \label{fig:init-stst-end-L-pol-n}
         \centering
         \includesvg[inkscapelatex=false, width=\textwidth]{Results/stst_policies_n_end_L_limit_permanent_initial.svg}
     \end{subfigure}
...
%\caption*{Figure {\hypersetup{hidelinks}\ref{fig:baseline-permanent-wedge-agg-extra}} Continued}
