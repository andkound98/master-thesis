...
& \\
& \\
Date of Submission: & \printdate{2023-8-26}\\
...
\begin{align}
    ...
    V_{b,t} (e_{i,t}, b_{i,t-1}) &= RR (RR_t, b_{i,t-1}) x_{i,t}^{-\sigma_c}, \label{eq:foc-envelope} % two first-order conditions (\Gls{foc}) and an envelope condition.
\end{align}
...
\begin{figure}[t]
    ...
    \label{fig:baseline-permanent-limit-dist-a-response-all}
         \centering
         \includesvg[inkscapelatex=false, width=\textwidth]{Results/a_on_impact_over_dist_baseline_limit_permanent_None.svg}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.49\textwidth}
     ...
     \label{fig:baseline-permanent-limit-dist-a-response-debt}
         \centering
         \includesvg[inkscapelatex=false, width=\textwidth]{Results/a_on_impact_over_dist_baseline_limit_permanent_0.svg}
     \end{subfigure}
...
\begin{figure}[H]
\centering
\caption{Graphical Representation of Baseline Model}
...
\label{sec:app-hh-natural-borrowing-limit}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
     ...
     \label{fig:asymmetry-long-run-D}
         \centering
         \includesvg[inkscapelatex=false, width=\textwidth]{Results/compare_transitions/comparison_D_baseline_limit_permanent_baseline_limit_permanent_asymmetric_long_run_debt.svg}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.49\textwidth}
     \caption{Debt-to-Output, $\frac{D}{y}$}
     \label{fig:asymmetry-long-run-DY}
         \centering
         \includesvg[inkscapelatex=false, width=\textwidth]{Results/compare_transitions/comparison_DY_baseline_limit_permanent_baseline_limit_permanent_asymmetric_long_run_debt.svg}
     \end{subfigure}
...
\begin{figure}[H]
    \caption{Baseline w/o \Gls{zlb} -- Shock to Borrowing Limit: Aggregate Dynamics}
